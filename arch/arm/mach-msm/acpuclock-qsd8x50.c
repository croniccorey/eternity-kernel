...
struct clkctl_acpu_speed acpu_freq_tbl[] = {
  ...
  { 1250000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x1A, 0, 1300, 128000 , 0 },
  { 1300000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x1B, 0, 1300, 128000 , 0 },
  { 1350000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x1C, 0, 1325, 128000 , 0 },
  { 1400000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x1D, 0, 1325, 128000 , 0 },
  { 1450000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x1E, 0, 1325, 128000 , 0 },
  { 1500000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x1F, 0, 1325, 128000 , 0 },
  { 1550000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x20, 0, 1350, 128000 , 0 },
  { 1600000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x21, 0, 1350, 128000 , 0 },
  { 1650000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x22, 0, 1350, 128000 , 0 },
  { 1700000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x23, 0, 1350, 128000 , 0 },
  { 1750000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x24, 0, 1350, 128000 , 0 },
  { 1800000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x25, 0, 1375, 128000 , 0 },
  { 1850000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x26, 0, 1375, 128000 , 0 },
  { 1900000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x27, 0, 1375, 128000 , 0 },
  { 1950000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x28, 0, 1375, 128000 , 0 },
  { 2000000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x2A, 0, 1400, 128000 , 0 }, //
  { 2100000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x2B, 0, 1400, 128000 , 0 }, // Experimental *USE AT YOUR OWN RISK*
  { 2200000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x2C, 0, 1400, 128000 , 0 }, //
  { 0 },
};
